...
import { getSavedProducts, getProductCategories } from '../lib/products'
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-950 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Filter Sidebar */}
        <div
          className={`fixed left-0 top-0 z-30 h-full w-full overflow-auto bg-white transition-transform duration-300 md:static md:w-80 md:flex-shrink-0 md:border-r md:border-zinc-200 md:translate-x-0 ${
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-200 bg-zinc-100 px-4 py-6 sm:px-6 sm:py-8 mt-auto">
