        ...
        <footer className="bg-gray-800 text-white py-12">
            <div className="w-full max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-lg font-bold mb-4">Unilavras</h3>
                        <p className="text-gray-400 text-sm">Inovação no ensino e em vestir os alunos.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <a href="https://x.com/Unilavras" target="_blank" rel="external" className="text-gray-400 hover:text-white transition">
                            ...
                            <a href="https://www.instagram.com/unistoreunilavras/" target="_blank" rel="external" className="text-gray-400 hover:text-white transition">
                                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="mt-10 border-t border-white/10 pt-6 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center text-sm text-gray-400">
                    <p className="text-center sm:text-left">&copy; 2026 Unilavras. Todos os direitos reservados.</p>
